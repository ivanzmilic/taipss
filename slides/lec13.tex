...
\begin{itemize}
\item This will be a set of short questions, numerical problems or more theoretical / conceptual questions to test what you remembered and help you prepare for the exam.
\item We will have a series of questions, followed by answers. 
\end{itemize}
}
%
%
...
\item This is consistent with a solution of Einstein's equations. 
\end{itemize}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\begin{figure}
\includegraphics[width=6.5cm]{figures/hubbled.png}
\caption*{Original Hubble diagram from 1924}
\end{figure}
\end{minipage}
}
%
%
\frame{
\frametitle{How did Hubble measure distances?}
\begin{minipage}{0.50\linewidth}
\begin{itemize}
\item He used another type of standard candles - Cepheid variable stars. 
\item Around that time, Henrietta Swan Leavitt established the connection between the \textbf{mean absolute brightness and the period} of these variable stars.
\begin{equation}
<M_V> = -2.11 \log10 P - 0.6
\end{equation} 
\item Measuring the period \textbf{immediately} gives us the absolute magnitude. 
\item And then, as always: $m = M - 5 + 5\log d$
\end{itemize}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\begin{figure}
\includegraphics[width=6.5cm]{figures/dcl.jpg}
\caption*{Lightcurve of delta cephei}
\end{figure}
\end{minipage}
}
%
%
\frame{
\frametitle{Why does the brightness of Cepheid vary?}
\begin{minipage}{0.50\linewidth}
\begin{itemize}
\item Cepheids are kind of pulsating stars.
\item Their brightness changes substantially. How come? \q{Does the energy production change?}
\end{itemize}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\begin{figure}
...
%
\frame{
\frametitle{Kappa ($\kappa$) mechanism}
\begin{minipage}{0.50\linewidth}
\begin{itemize}
\item We have seen that opacity is an essential ingredient of stellar structure. 
\item In cepheids, the structure is such that the star constantly goes between states where Helium is once and twice ionized. 
\item This causes substantial changes in opacity, and thus structure. 
\item Pulsations ensue. There is, obviously, a lot of open question.
\end{itemize}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\begin{figure}
\includegraphics[width=6.5cm]{figures/pulsating.jpg}
\caption*{Cepheid pulsations}
\end{figure}
\end{minipage}
}
%
%
\frame{
\frametitle{Other variable stars}
\begin{minipage}{0.50\linewidth}
\begin{itemize}
\item There are different kinds of Cepheids (type I, type II)
\item Also, RR Lyrae stars
\item And $\delta$ Scuti variable stars. 
\item All these are important for understanding specific phases in stellar evolution but also as standard candles. 
\end{itemize}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\begin{figure}
\includegraphics[width=6.5cm]{figures/HRvar.png}
\caption*{Cepheid pulsations}
\end{figure}
\end{minipage}
}
...
\begin{itemize}
\item This was a story about stars that significantly depart from what we have been discussing so far.
\item A lot of research, both theoretical and observational is revolving around these phenomena. 
\item If you are interested in future reading - let us know! We will also post some review articles. 
\item This is also the end of our course: 
\item Next hands on: solving HW2
\item Next class: test exam
\item \textbf{Exam, 30th of June, 10:00}
\end{itemize}
}
%
%
