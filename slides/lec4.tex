...
\begin{itemize}
\item For a radiative star the total flow of energy (W/s) is
...
\item It was adapted to astrophysics by Ludwig Biermann in the 1930s
  and the most widely used version still is due to Erika
  B\"ohm-vitense (1958); see also Vitense (1953).
