...
Lecture 9: Solar oscillations and helioseismology}
...
%
\frame{
\frametitle{Pulsating stars - Cursory introduction}
...
\item Some of these stars (e.g.\ the Cepheids) are very important in
  ...
  candles}. We will talk more about these next week.
\item Here we will concentrate only on solar-like oscillations.
\item These are, in a way, simple perturbations of hydrostatic structure of the star.
\end{itemize}
\end{minipage}
...
\item Solutions are in the form of plane waves:
  \begin{equation}
