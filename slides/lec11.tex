...
\begin{minipage}{0.55\linewidth}
\begin{figure}
\includegraphics[width=7.5cm]{figures/exo_kepler.png}
\end{figure}
\end{minipage}
}
%
...
\begin{minipage}{0.55\linewidth}
\begin{figure}
\includegraphics[width=7.5cm]{figures/ceb_lc.png}
\end{figure}
\end{minipage}
}
%
...
\begin{itemize}
\item The shape of constant potential energy around the binary star system is called \textbf{Roche lobe}.
...
\begin{figure}
\includegraphics[width=7.5cm]{figures/sw_poster.png}
\caption*{Three different types of supernovae and their evolutionary paths. Credits:}
\end{figure}
}
%
%
\frame{
\frametitle{Supernovae - standard candles}
\begin{figure}
\includegraphics[width=7.5cm]{figures/sw_poster.png}
\caption*{Three different types of supernovae and their evolutionary paths. Credits:}
\end{figure}
