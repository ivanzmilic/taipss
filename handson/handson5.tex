...
\title{Hands-on exercises 5: Ionization of stellar material}
...
And, once again, mostly analytical exercises, but with some actual calculations so keep python handy! 

{\bf Problem 1:} Convince yourself that, for stellar atmospheres, the mean molecular mass depends on the degree of ionization. For given gas pressure, assuming the gas consists only of hydrogen, calculate mass density for molecular, completely neutral and completely ionized hydrogen. 

{\bf Problem 2:} Using the results of the previous step - derive the equation of state (relationship between gas pressure, mass density and temperature) for pure hydrogen. Discuss what happens when we have more than one species. 

{\bf Problem 3:} Show that the adiabatic temperature gradient can be
written as
\begin{equation}
