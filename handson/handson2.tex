...
\end{equation}
Use this argument to show that the temperature has to drop of with the radius if the total flux is constant (assume that plasma locally behaves as a black body).
