...
{\bf Problem 1:} Use the Navier-Stokes equation
\begin{equation}
...
{\bf Problem 3:} This problem builds upon one of the recent exercise problems. Use the equations of hydrostatic equilibrium and mass
conservation:
\begin{eqnarray}
